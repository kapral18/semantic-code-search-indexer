...
import type { JsonObject } from '../../types/kbn_types';
import type { estypes } from '@elastic/elasticsearch';
import { nodeTypes } from '../node_types';
import { KQLSyntaxError, KQLSyntaxErrorData } from '../kuery_syntax_error';
...
export const fromKueryExpression = (
  ...
  try {
    ...
    if (error.name === 'SyntaxError') {
      throw new KQLSyntaxError(error as KQLSyntaxErrorData, expression);
    } else {
      throw error;
    }
  }
